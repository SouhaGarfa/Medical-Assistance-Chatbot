...
def process_image(image_path, query):
    try : 
        ...
        llama_4_scout_17b_response = make_api_request("meta-llama/llama-4-scout-17b-16e-instruct")
        llama_4_maverick_17b_response = make_api_request("meta-llama/llama-4-maverick-17b-128e-instruct")
        responses={}
        for model,response in [("llama_scout",llama_4_scout_17b_response),("llama_maverick",llama_4_maverick_17b_response)] :
            if response.status_code == 200:
                ...
                responses[model]=f"Error from {model} API : {response.status_code} - {response.text} "
